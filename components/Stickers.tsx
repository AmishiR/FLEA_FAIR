...
export const StickerCluster: React.FC = () => {
  ...
  return (
    <section className="w-full flex justify-center md:justify-start items-center px-4 sm:px-6 md:px-8 mt-10 md:mt-0">
      {/* Cluster wrapper – behaves like Hero image blocks */}
      <div className="relative w-full max-w-[320px] sm:max-w-[420px] md:max-w-[520px] aspect-[1.1/1]">

        <motion.img
          src="/SMALL_BUISNESS.png"
          alt="Small Business"
          className="absolute bottom-[28%] left-[10%] w-[78%] -rotate-[2deg] z-20"
          {...scaleIn}
        />
